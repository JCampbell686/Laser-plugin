...
(This looks like a lot of "work", but there's like 3 minutes worth of tasks here)
...
https://prnt.sc/j2DycjjDsFBk

^ Make a sequence player, set it to the carrying animation, then use the Grabbing variable as the alpha
